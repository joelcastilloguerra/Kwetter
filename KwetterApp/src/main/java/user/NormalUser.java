...
public class NormalUser implements IUser{
    ...
    public NormalUser(int id, String profilePicture, String username, String name, String bio, String location, String website, List<IUser> following, List<IUser> followers, List<IPostable> likedTweets, List<IPostable> tweets) {
        this.id = id;
